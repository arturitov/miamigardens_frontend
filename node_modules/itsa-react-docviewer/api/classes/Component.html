...
<head>
    <meta charset="utf-8">
    <title>Component - itsa-react-docviewer</title>
...
<div class="box meta">
        ...
        <div class="foundat">
            ...
            Module: <a href="../modules/component.jsx.html">component.jsx</a>

</div>


<div class="box intro">
    <p>React component that views documents using Google Doc Viewer.</p>
                ...
                <div class="index-section properties">
                    ...
                    <ul class="index-list properties">
                            <li class="index-item property">
                                <a href="#property_allowFullScreen">allowFullScreen</a>
                            ...
                            <li class="index-item property">
                                <a href="#property_scrolling">scrolling</a>
...
<div id="method_fullScreen" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/lib_component.jsx.html#l45"><code>lib&#x2F;component.jsx:45</code></a>
        </p>
    ...
    <div class="description">
        <p>Will show the content into the full screen. Only if <code>props.allowFullScreen</code>===true.</p>
...
<div id="method_render" class="method item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/lib_component.jsx.html#l59"><code>lib&#x2F;component.jsx:59</code></a>
        </p>



            <p>Available since 15.0.0</p>
    </div>
...
<div id="property_allowFullScreen" class="property item">
    <h3 class="name"><code>allowFullScreen</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/lib_component.jsx.html#l115"><code>lib&#x2F;component.jsx:115</code></a>
        </p>
    ...
    <div class="description">
        <p>Allowed to be displayed into full screen mode, by calling <code>fullScreen()</code></p>
...
<div id="property_className" class="property item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/lib_component.jsx.html#l124"><code>lib&#x2F;component.jsx:124</code></a>
        </p>
    ...
    <div class="description">
        <p>Any class to be set on the main component.</p>
...
<div id="property_scrolling" class="property item">
    <h3 class="name"><code>scrolling</code></h3>
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/lib_component.jsx.html#l135"><code>lib&#x2F;component.jsx:135</code></a>
        </p>
    ...
    <div class="description">
        <p>Whether the browser should provide a scroll bar when needed.
Either <code>auto</code>, <code>yes</code> or <code>no</code></p>
...
<div id="property_src" class="property item">
    ...
    <div class="meta">
                <p>
                Defined in
        <a href="../files/lib_component.jsx.html#l148"><code>lib&#x2F;component.jsx:148</code></a>
        </p>
    ...
    <div class="description">
        <p>The url of the document to be viewed. May be absolute or relative.</p>
